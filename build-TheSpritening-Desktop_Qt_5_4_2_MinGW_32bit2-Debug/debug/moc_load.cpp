...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Load_t, stringdata) + ofs \
...
const QMetaObject Load::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Load.data,
      qt_meta_data_Load,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Load::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Load.stringdata))
