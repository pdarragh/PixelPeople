...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        horizontalLayoutWidget->setGeometry(QRect(70, 410, 1021, 194));
        ...
        horizontalSlider->setMaximum(65);
        ...
        forward_2 = new QPushButton(centralWidget);
        forward_2->setObjectName(QStringLiteral("forward_2"));
        forward_2->setGeometry(QRect(210, 200, 31, 32));
        QIcon icon7;
        icon7.addFile(QStringLiteral(":/new/imageassets/fast_forward.png"), QSize(), QIcon::Normal, QIcon::Off);
        forward_2->setIcon(icon7);
